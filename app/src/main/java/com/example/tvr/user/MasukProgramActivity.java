...
public class MasukProgramActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        judul = findViewById(R.id.textViewAppName);
        judul.setText(selectedProgram);
        ...
        query.get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                ...
                for (QueryDocumentSnapshot documentSnapshot : queryDocumentSnapshots) {
                    ...
                    if (selectedProgram.equals("ALAT KELENGKAPAN DEWAN") && program.getSubProgram().equals(subProgram)) {
