package com.example.tvr.adapter;
...
import com.example.tvr.user.DetailPodcastActivity;
import com.example.tvr.model.Podcast;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("podcastProgram", podcast.getProgram());
                intent.putExtra("podcastSubProgram", podcast.getSubProgram());
