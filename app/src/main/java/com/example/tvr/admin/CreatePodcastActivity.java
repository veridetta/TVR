...
public class CreatePodcastActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String subprogram = spinnerSubProgram.getSelectedItem().toString();
                ...
                if (coverUri != null && audioUri != null) {
                    ...
                    savePodcastData(podcastId, title, description,program,subprogram);
                } else {
    ...
    private void savePodcastData(String podcastId, String title, String description, String program, String subProgram) {
        progressDialog.show();
                                            ...
                                            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                                ...
                                                audioRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                                    ...
                                                    public void onSuccess(Uri audioUrl) {
                                                        // Menyimpan data podcast ke Firestore
                                                        Podcast podcast = new Podcast(podcastId, title, description, coverUrl.toString(), audioUrl.toString(),program,subProgram);
